...
var _rotateCard = require('./rotate-card');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _reactMotion.Motion,
        {
          ...
          style: { deg: (0, _reactMotion.spring)(this.targetDegree) } },
        function (interpolatingStyle) {
          return _react2.default.createElement(_rotateCard2.default, _extends({
